...
export default (state = initialState, action) => {
  switch (action.type) {
    ...
    case "GET_ALL_BOOKS_SUCCESS":
      return { ...state, books: action.toys, isLoading: false };

    case "GET_BOOK_OWNERSHIPS_SUCCESS":
      return { ...state, bookOwnerships: action.bookOwnerships };

    case "SET_CURRENT_USER":
      return { ...state, currentUser: action.user };

    case "GET_USER_BOOK_SUCCESS":
      let myBooks = action.user.books.map((t) => {
        t.claimed = "true";
        return t;
      });
      return { ...state, userBooks: myBooks };
    ...
    case "ADD_BOOK_OWNERSHIP_SUCCESS":
      ...
      return {
        ...state,
        bookOwnerships: [...state.bookOwnerships, action.bookOwnership],
    ...
    case "REMOVE_BOOK_OWNERSHIP_SUCCESS":
      ...
      //let updateMyToys = [...state.userBooks]
      ...
      return {
        ...state,
        bookOwnerships: state.bookOwnerships.filter(
          (to) => to.id !== action.bookOwnership.id
        ),
